...
int main()
{
	...
	while (prog)
	{
		...
		while (mem)
		{
			...
			while (ch)
			{
				cout << "\nВыберите номер товара, который хотите добавить в корзину (0 - выход): ";
				cin >> choice;
		...
		{
			if ((basket[5] / 4) == 1)
				cout << "В подарок " << basket[5] / 4 << " банка лукового сока!\n";
			if ((basket[5] / 4) >= 2 && (basket[5] / 4) <= 4)
				cout << "В подарок " << basket[5] / 4 << " банки лукового сока!\n";
			if (basket[5] / 4 >= 5)
				cout << "В подарок " << basket[5] / 4 << " банок лукового сока!\n";
